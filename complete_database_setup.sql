-- Complete E-Commerce Database Setup with Sample Data
-- This file contains all the SQL code needed to create the database schema and populate it with sample data
